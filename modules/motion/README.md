...
estimator with optional pyramid levels and low-motion pose shrink, and one-pass
rigid-motion application over `NeuroVec[Double]`. Profile components report
currently implemented behavior; IC stencil, whitening, parallel execution,
spline acquisition timing, JVM NIfTI IO, CLI, and report writers are staged
later layers.
