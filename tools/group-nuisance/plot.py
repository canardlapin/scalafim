...
assert len(rows)==8, 'confirmation must finish before rendering'
...
fig=plt.figure(figsize=(14.5,10),facecolor='#fafbf9');gs=fig.add_gridspec(2,2,width_ratios=[1.25,1],hspace=.54,wspace=.45,left=.25,right=.97,top=.82,bottom=.20)
