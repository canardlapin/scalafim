...
Open `target/graphics-position-qa/index.html`. The page places seventeen 640 x 480
...
histogram, density, summary, ribbon, tile, heatmap, 2D bin, 2D KDE, contour, filled contour, count, and facet data give direct
