...
Open `target/graphics-position-qa/index.html`. The page places fourteen 640 x 480
...
histogram, density, summary, ribbon, tile, heatmap, 2D bin, count, and facet data give direct
