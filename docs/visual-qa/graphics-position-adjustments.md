...
Open `target/graphics-position-qa/index.html`. The page places thirteen 640 x 480
...
histogram, density, summary, ribbon, tile, heatmap, count, and facet data give direct
